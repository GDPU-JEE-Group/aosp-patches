...
//
    ...
    public int getLeState() {
        ...
        try {
            ...
            if (mService != null) {
                // state = mService.getState();
                state = mMock.getState(BluetoothAdapter.STATE_OFF);
            }
        } catch (Exception e) {
            Log.e(TAG, "", e);
        } finally {
    ...
    public ParcelUuid[] getUuids() {
        ...
        try {
            mServiceLock.readLock().lock();
            if (mService != null) {
                ParcelUuid[] aa=new ParcelUuid[0];
                return aa;
    ...
    public int getIoCapability() {
        ...
        try {
            mServiceLock.readLock().lock();
            if (mService != null) return BluetoothAdapter.IO_CAPABILITY_UNKNOWN;
