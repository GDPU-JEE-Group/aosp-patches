...
# Filtering rules
$IPTABLES -A droidwall-3g -m owner --uid-owner 10094 -j droidwall-reject || exit 
$IPTABLES -A droidwall-wifi -m owner --uid-owner 10094 -j droidwall-reject || exit 
$IPTABLES -A droidwall-eth0 -m owner --uid-owner 10094 -j droidwall-reject || exit
exit
